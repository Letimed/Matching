...
while idPlayer < 200:
	...
	f.write(str(idPlayer)+';'+str(nbwin)+';'+str(nblose)+';'+str(nbtotalgame)+';'+str(tempsmoyennesparties)+';'+str(kill)+';'+str(death)+';'+str(assist)+';'+str(honor)+';'+str(report)+';'+str(ratevictory)+';'+str(pctafk)+';'+str(nationalite)+';'+str(gold)+';'+str(gameCurrency)+'\n')
	idPlayer = idPlayer + 1
f.close()
